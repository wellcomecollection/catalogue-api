    ...
    it("on a single work endpoint") {
      withWorksApi {
        case (worksIndex, routes) =>
          ...
          assertJsonResponse(
            routes,
            s"$rootPath/works/oo9fg6ic?include=identifiers"
          ) {
            Status.OK ->
              s"""
                 |{
    ...
    it("on a single work endpoint") {
      withWorksApi {
        case (worksIndex, routes) =>
          ...
          assertJsonResponse(
            routes,
            s"$rootPath/works/oo9fg6ic?include=subjects"
          ) {
            Status.OK ->
              s"""
                 |{
    ...
    it("on a single work endpoint") {
      withWorksApi {
        case (worksIndex, routes) =>
          ...
          assertJsonResponse(
            routes,
            s"$rootPath/works/oo9fg6ic?include=contributors"
          ) {
            Status.OK ->
              s"""
                 |{
    ...
    it("on a single work endpoint") {
      withWorksApi {
        case (worksIndex, routes) =>
          ...
          assertJsonResponse(
            routes,
            s"$rootPath/works/oo9fg6ic?include=production"
          ) {
            Status.OK ->
              s"""
                 |{
    ...
    it("on a single work endpoint") {
      withWorksApi {
        case (worksIndex, routes) =>
          ...
          assertJsonResponse(
            routes,
            s"$rootPath/works/oo9fg6ic?include=languages"
          ) {
            Status.OK ->
              s"""
                 |{
    ...
    it("on a single work endpoint") {
      withWorksApi {
        case (worksIndex, routes) =>
          ...
          assertJsonResponse(
            routes,
            s"$rootPath/works/oo9fg6ic?include=holdings"
          ) {
            Status.OK ->
              s"""
                 |{
    ...
    it("?include=precededBy") {
      withWorksApi {
        case (worksIndex, routes) =>
          ...
          assertJsonResponse(
            routes,
            s"$rootPath/works/oo9fg6ic?include=precededBy"
          ) {
            Status.OK ->
              s"""
                 |{
    ...
    it("?include=succeededBy") {
      withWorksApi {
        case (worksIndex, routes) =>
          ...
          assertJsonResponse(
            routes,
            s"$rootPath/works/oo9fg6ic?include=succeededBy"
          ) {
            Status.OK ->
              s"""
                 |{
